...
const Body = ({ viewPortControl }) => {
  ...
  return (
    <div className="header-one relative lg:ml-12">
      ...
      <div className="text-center mx-6 lg:mx-0 mt-10  lg:w-2/5 lg:h-4/6 lg:absolute lg:bottom-0 lg:right-24  bg-white">
        <h2 className="text-4xl lg:text-5xl lg:pt-20 uppercase  font-light">
          The Leader in interactive Vr
        </h2>

        <p className="mx-6 pt-4 lg:pt-6 lg:px-8 font-secondary lg:text-left text-darkerGray font-normal">
